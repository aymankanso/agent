"""
Chat History Page (refactored)
Removed unnecessary wrapper functions, applied new component and business logic structure
"""
...
def _handle_replay(session_id: str):
    """Handle replay button (improved - load conversation history directly)
