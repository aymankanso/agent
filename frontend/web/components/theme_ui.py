"""
Theme UI Component (refactored - pure UI logic)
Theme toggle button, theme CSS application and other theme-related UI rendering
"""
...
class ThemeUIComponent:
    ...
    def load_theme_css(self, theme: str = "dark") -> str:
        ...
        try:
            ...
            print(f"Theme CSS file loading error: {str(e)}")
            return ""
    ...
    def _generate_theme_overrides(self, colors: Dict[str, str], theme: str) -> str:
        ...
        /* Streamlit theme overrides - using strong selectors */
        ...
        for css_file in css_files:
            ...
            if css_path.exists():
                try:
                    ...
                    print(f"CSS file loading error ({css_file}): {e}")
    ...
    def create_theme_toggle(
        ...
        Args:
            ...
            callback: Theme change callback function
            
        Returns:
            bool: Whether theme was changed
        """
    ...
    def apply_page_theme(self, theme: str = "dark"):
        ...
        # Basic page settings
        st.set_page_config(
            page_title="AI Red Teaming Multi-Agent",
