...
class ConversationEvent:
    """Minimal event information needed for replay"""
...
class ConversationSession:
    """Minimal session information needed for replay"""
    session_id: str
    start_time: str
...
class ConversationLogger:
    ...
    def log_tool_execution(self, tool_name: str, content: str, **kwargs) -> str:
        """Log tool execution - Convert to tool_command"""
        return self.log_event(
...
def get_conversation_logger() -> ConversationLogger:
    """Return global conversation logger instance"""
...
def set_conversation_logger(logger: ConversationLogger):
    """Set global conversation logger"""
    global _global_logger
