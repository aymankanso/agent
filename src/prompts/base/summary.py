...
This file defines the base prompt for the Summary agent.
Used commonly across all architectures.
"""

BASE_SUMMARY_PROMPT = """
<language_instructions>
Respond in English. Technical terms, commands, and tool names should be in English. All explanations, analysis, and summaries should be provided in English.
